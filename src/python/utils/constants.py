...
SIG_BOUNDARY1 = 4
SIG_ENEMY2 = 5
SIGNATURE_LIST_blue = [SIG_ENEMY1, SIG_DEFAULT1, SIG_SELF1, SIG_BOUNDARY1, SIG_ENEMY2]
SIGNATURE_LIST_red = [SIG_SELF1, SIG_DEFAULT1, SIG_ENEMY1, SIG_BOUNDARY1, SIG_ENEMY2]
SIGNATURE_LIST = SIGNATURE_LIST_red
TARGET_WEIGHT_MATRIX = [1., 1., 0., 0., 0.]
...
MAX_TIME_TURN_WALL = .6
MIN_TIME_TURN_WALL = .4
MAX_Y_WALL = 75
...
TWEET_HIT_PROB = 1.0
TWEET_FIRE_PROB = 0.04
TWEET_SEARCH_PROB = 0.01
TWEET_CHASE_PROB = 0.01
TWEET_ROAM_PROB = 0.01
TWEET_WALL_PROB = 0.01
